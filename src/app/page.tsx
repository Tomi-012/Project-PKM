...
export default function Home() {
  ...
  const popularAI = [
    ...
    },
    {
      ...
      icon: 'https://runwayml.com/favicon/favicon-32x32.png',
      color: 'bg-black',
  ...
  const allAI = [
    ...
    },
    {
      ...
      icon: 'https://logos-world.net/wp-content/uploads/2025/02/Google-Gemini-Symbol.png',
      color: 'bg-white-400',
    ...
    },
    {
      ...
      icon: 'https://img.alicdn.com/imgextra/i2/O1CN013s5N4Y1s8z8j8qJ8_!!6000000005721-2-tps-180-180.png',
      color: 'bg-orange-500',
    ...
    },
    {
      ...
      icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Meta_Platforms_logo.svg/1024px-Meta_Platforms_logo.svg.png',
      color: 'bg-blue-900',
    ...
    },
    {
      ...
      icon: 'https://www.deepseek.com/deepseek.ico',
      color: 'bg-green-200',
    ...
    },
    {
      ...
      icon: 'https://copilot.microsoft.com/favicon.svg',
      color: 'bg-white',
    ...
    },
    {
      ...
      icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/X_logo_2023.svg/1024px-X_logo_2023.svg.png',
      color: 'bg-black',
      url: 'https://grok.com',
      category: 'Chatbot AI',
      tags: ['Premium'],
    ...
    },
    {
    ...
    },
     {
      ...
      icon: 'https://www.steve.ai/assets/images/logo_steve_new.svg',
      color: 'bg-white',
    ...
    },
    {
      ...
      icon: 'https://www.heygen.com/favicon-light.ico',
      color: 'bg-blue-100',
    ...
    },
    {
      ...
      icon: 'https://assets-global.website-files.com/612640a70f3853b8509311dc/6447141979434e32341d3478_favicon-32x32.png',
      color: 'bg-teal-100',
    ...
    },
    {
      ...
      icon: 'https://app.suno.ai/favicon.svg',
      color: 'bg-lime-100',
      url: 'https://suno.com/',
      category: 'AI Music',
      tags: ['Free', 'Premium'],
    ...
    },
    {
      ...
      icon: 'https://soundful.com/favicon.ico',
      color: 'bg-red-100',
    ...
    },
    {
      ...
      icon: 'https://krita.org/wp-content/uploads/2021/01/Krita_logo_256x256.png',
      color: 'bg-sky-100',
    ...
    },
    {
    ...
    },
     {
      ...
      icon: 'https://static.grammarly.com/assets/files/95616e4c2a3138b13d2331575b436952/favicon.ico',
      color: 'bg-green-100',
    ...
    },
    {
      ...
      icon: 'https://uploads-ssl.webflow.com/63193fb583060c1845618f3a/63346399c0643f013d33648a_256.png',
      color: 'bg-orange-100',
    ...
    },
    {
      ...
      icon: 'https://jenni.ai/favicon-32x32.png',
      color: 'bg-blue-100',
      url: 'https://jenni.ai/',
      category: 'AI Writing',
      tags: ['Free', 'Premium'],
    ...
    },
    {
      ...
      icon: 'https://writesonic.com/favicon-32x32.png',
      color: 'bg-sky-200',
    ...
    // AI Productivity
    {
      ...
      icon: 'https://fireflies.ai/favicon-32x32.png',
      color: 'bg-red-200',
    ...
    },
    {
      ...
      icon: 'https://otter.ai/favicon-32x32.png',
      color: 'bg-sky-100',
      url: 'https://otter.ai/',
      category: 'AI Productivity',
      tags: ['Free', 'Premium'],
    ...
    },
    {
      ...
      icon: 'https://answerthepublic.com/favicon.ico',
      color: 'bg-orange-100',
    ...
    },
    {
      ...
      icon: 'https://www.connectedpapers.com/favicon.ico',
      color: 'bg-teal-100',
    ...
    },
    {
      ...
      icon: 'https://somai.id/favicon.ico',
      color: 'bg-red-200',
      url: 'https://somai.id',
      category: 'Platform AI',
      tags: ['Commercial'],
    ...
    // AI Marketing
    {
      ...
      icon: 'https://www.adcreative.ai/favicon-32x32.png',
      color: 'bg-indigo-100',
    ...
    },
    {
      ...
      icon: 'https://simplified.com/favicon-32x32.png',
      color: 'bg-rose-100',
    ...
    },
    {
      ...
      icon: 'https://www.trypencil.com/favicon-32x32.png',
      color: 'bg-gray-200',
